...
<div style="text-align: center">
    <form action="${pageContext.request.contextPath}/item/list" method="get">
        名称:<input type="text" name="keyword" value="${keyword}"> <input type="submit" value="查询"><input type="button" value="新增" onclick="addItem()">
    </form>
</div>
<table>
    <tr>
...
<script type="text/javascript">
    ...
    /*添加商品*/
    function addItem() {
        location.href = "${pageContext.request.contextPath}/item/addItem";
    }
</script>
</html>
