...
public class SmsUtil {
	...
	static final String accessKeyId = "LTAI72WSsJMiC7Lp";//LTAI72WSsJMiC7Lp
	static final String accessKeySecret = "AouMkSpPZEieVNGLpT4jAEwrOKXsRn";//AouMkSpPZEieVNGLpT4jAEwrOKXsRn
	...
	public static SendSmsResponse sendSms(String phone, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("纳米音乐课堂");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_153325912");
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		System.out.println(sendCode("15657567094", "1234"));
	}

	public static boolean sendCode(String phone, String code) throws ClientException, InterruptedException {
