...
public class Package {
	...
	public String toString() {
		return "Package [id=" + id + ", sid=" + sid + ", packageName=" + packageName + ", packageStatus="
				+ packageStatus + ", startTime=" + startTime + ", endTime=" + endTime + ", priority=" + priority
				+ ", sale=" + sale + ", packagePicture=" + packagePicture + ", peopleNumber=" + peopleNumber
				+ ", currentStock=" + currentStock + ", maxStock=" + maxStock + ", price=" + price
				+ ", packageCategory=" + packageCategory + ", packageSort=" + packageSort + ", opens=" + opens + "]";
	}
